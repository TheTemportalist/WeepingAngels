...
public class EntityWAPainting extends EntityPainting
{
    ...
    public EntityWAPainting(World par1World, int par2, int par3, int par4, int par5)
    {
    ...
    public EntityWAPainting(World par1World, int par2, int par3, int par4, int par5, String par6Str)
    {
