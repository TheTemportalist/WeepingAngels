package com.countrygamer.angel.client.model;
...
public class ModelWeepingAngel extends ModelBase {
	...
	public void setRotationAngles(Entity entity, float f, float f1, float f2,
		...
		if (entity instanceof EntityWeepingAngel) {
			if (((EntityWeepingAngel) entity).angryState() == 1) {
			...
			if (((EntityWeepingAngel) entity).armState() >= 2) {
			...
			} else if (((EntityWeepingAngel) entity).armState() == 1) {
